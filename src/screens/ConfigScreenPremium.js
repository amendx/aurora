...
export default function ConfigScreenPremium({ navigation }) {
  ...
  const renderInputField = (label, value, onChangeText, prefix = 'R$') => (
      ...
      >
        ...
        <View style={styles.sectionCard}>
          <View style={styles.cardHeader}>
            ...
            <Text style={styles.cardTitle}>Valores durante a semana</Text>
          </View>
          
          <View style={styles.inputGrid}>
            {renderInputField(
              'Manhã / Tarde',
              hourValues.weekday.day,
              (value) => handleHourChange('weekday', 'day', value)
            )}
            {renderInputField(
              'Noite',
              hourValues.weekday.night,
              (value) => handleHourChange('weekday', 'night', value)
            )}
          </View>
        </View>
        ...
        <View style={styles.sectionCard}>
          <View style={styles.cardHeader}>
            ...
            <Text style={styles.cardTitle}>Valores fim de semana</Text>
          </View>
          
          <View style={styles.inputGrid}>
            {renderInputField(
              'Manhã / Tarde',
              hourValues.weekend.day,
              (value) => handleHourChange('weekend', 'day', value)
            )}
            {renderInputField(
              'Noite',
              hourValues.weekend.night,
              (value) => handleHourChange('weekend', 'night', value)
            )}
          </View>
        </View>
